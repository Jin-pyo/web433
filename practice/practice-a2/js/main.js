...
$(function()
{
    ...
    $("#data-table tbody").on("click","tr", function(e){
        ...
        console.log(item)
        //$("#itemModal").html()
        //$("#bodybody").modal(saleModelBodyTemplate(item))
        $("#hh").html(saleModelBodyTemplate(item));
    });
...
function getData()
{
    items.length=0;
    $("#page").text(page)
    $.getJSON(`https://limitless-lowlands-92948.herokuapp.com/api/sales/?page=${page}&perPage=${perPage}`, function(data)
    {        
